...
app.get('/', function(req,res){
  ...
  //res.render('view',{authorize_url: ( req.session.request_token ? req.session.request_token.authorize_url : null), account:{display_name:"name"}});
});
...
app.get('/view', function(req,res){
  if (req.session.app_info != null && req.session.access_token != null){
    ...
    console.log(req.session.app_info.root)
...
app.post('/json/setupKuaiPan', json.setupKuaiPan);
app.post('/json/setVerifier', json.setVerifier);
