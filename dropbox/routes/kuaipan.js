...
//授权码
var consumer_key = "xcNS6gKATUFy9Nam";
var consumer_secret = "DeXtVL9oi0ftsw4Q"
...
var oauth_token="451705350ea145839efd581981419c3c"
var oauth_token_secret="98575abbd20449b8adb1254f64cce3b5"
...
function getAccessToken(callback){
    ...
    console.log("getAccessToken:"+querystring.stringify(params))
	request(url+"?"+querystring.stringify(params),'get',function(d){
		var r=JSON.parse(d);
        console.log("access_token callback:"+querystring.stringify(r))
		if(r.user_id){
			oauth_token=r.oauth_token;
			oauth_token_secret=r.oauth_token_secret;
